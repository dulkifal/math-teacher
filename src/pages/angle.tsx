...
export default function AnglePage() {
  ...
  return (
    <div className="relative">
      <div className="grid grid-cols-2 gap-4 items-center justify-center relative w-full h-screen overflow-scroll">


        <div ref={ref} className="border-2 border-solid border-gray-300 relative w-full h-100">
          <button
            onClick={addLine}
            className="absolute top-4 left-4 p-3 text-gray-500 bg-blue-50 rounded-md z-10"
          >
            <FontAwesomeIcon icon={faPlus} />
          </button>
          <button
            onClick={handleUndo}
            className="absolute top-4 left-28 p-3 bg-blue-50 text-gray-500 rounded-md z-10"
            disabled={otherPoints.length === 0}
          >
            <FontAwesomeIcon icon={faRotateLeft} />
          </button>
          <svg className="absolute inset-0 w-full h-full" width="400" height="500">
